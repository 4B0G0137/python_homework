...
def generate_sample_data():
    ...
    for i in range(10):
        ...
        for course_code, course_name in [("Python", "Python Programming"),
...
class StudentGUI(QWidget):
    ...
    def create_display_all_tab(self):
        ...
        self.query_button_display_all.clicked.connect(
    ...
    def add_course(self):
        ...
        self.show_success_message("Course Added",
    ...
    def query_courses(self):
        ...
        if courses_info:
            for course in courses_info:
                self.result_browser_query.append(
    ...
    def display_all_students(self):
        ...
        for info in all_students_courses_info:
            self.result_browser_display_all.append(
                f"{info['student_id']} - {info['name']}:")
            self.result_browser_display_all.append(
                f"  Semester: {info['semester']}")
            self.result_browser_display_all.append(
                f"  {info['course_code']}: {info['course_name']}")
    ...
    def generate_excel_file(self, all_students_courses_info):
        ...
        # Set headers
        headers = [
            "Student ID", "Name", "Semester", "Course Code", "Course Name"
        ]
